Shader "SamHedges/CelShade" 
{
    Properties
    {
        ...
        [HideInInspector] _Blend("Blend type", Float) = 0
        ...
        // ToggleOff is similar to Toggle, but when the toggle is enabled, Unity disables the shader keyword; 
        // when the toggle is disabled, Unity enables the shader keyword. Additionally, the default name when you 
        // don't specify a shader keyword name is (uppercase property name)_OFF .
        ...
        [Gradient(512)] _LightingRampMap("Lighting Ramp", 2D) = "white" {}
        [Gradient(512)] _SpecularRampMap("Specular Ramp", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CelShadeForwardLitPass.hlsl"
