...
namespace UnityEditor.Rendering
{
    ...
    /// </summary>
    public static partial class StreamlineMaterialEditorExtension
    {
    ...
    public static partial class MaterialEditorExtension
    {
        ...
        /// <summary>
        /// Draw a special slider to specify a range between a min and a max for two float shader materialProperties.
        /// </summary>
        /// <param name="editor"><see cref="MaterialEditor"/></param>
